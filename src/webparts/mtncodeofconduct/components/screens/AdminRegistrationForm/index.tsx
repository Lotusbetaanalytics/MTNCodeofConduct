...
const AdminRegistrationForm = ({ context }) => {
  ...
  const submitHandler = (e) => {
    ...
    sp.web.lists
      ...
      .then((res) => {
        ...
        history.push("/admin/conduct/pledge");
        // setOpen(false);
        setLoading(false);
      })
      .catch((e) => {
        ...
        <div className="contentPage">
          <div className="dashboard">
            {/* <div className="header__title">
              <TitleHeader title="Admin Registration" />
            </div> */}
                        ...
                        content={
                          <div className={styles.mtnEligibilityGuildline}>
                            ...
                            <h5>
                              ...
                              Council Constitution, election into the MTNN
                              Employee Council holds once in two (2) years. The
                              last election took place in October 2018 and based
                              on the constitution, the next election is planned
                              to hold in October 2020.
                              <br />
                              As we prepare for another Employee Council
                              election scheduled to hold in October 30 2020,
                              find below the proposed plan for the forthcoming
                              elections, including general eligibility criteria
                              for contesting elective office etc. <br />
                              <br />
                              <span>Eligibility Criteria</span> <br />
                              <p>
                                Candidates that will contest for available seats
                                in each business region / location will be
                                required to meet the following criteria:
                              </p>
                              <ul>
                                <br />
                                <li>
                                  1. Only confirmed national staff on job levels
                                  1 & 2 are eligible to contest for seats on the
                                  Employee Council.
                                </li>
                                <br />
                                <li>
                                  2. ALL permanent national employees levels
                                  (both confirmed and unconfirmed) on levels 1 &
                                  2 are eligible to vote.
                                </li>
                                <br />
                                <li>
                                ...
                                <br />
                                <li>
                                  4. Incumbent representatives who have served
                                  two consecutive terms (i.e. 4 years) are not
                                  eligible to contest.
                                </li>
                                <br />
                                <li>
                                  5. Incumbent representatives who have served
                                  only one term (i.e. 2 years) are eligible to
                                  contest.
                                </li>
                                <br />
                                <li>
                                  6. Staff can only contest for allocated seats
                                  within their region/location.
                                </li>
                                <br />
                                <span>Nomination and Election</span>
                                <li>
                                  1. Election shall be through secret ballot
                                  (electronically), and will be coordinated by
                                  the Employee Relations Team with the Fraud
                                  Management unit.
                                </li>
                                <br />
                                <li>
                                  ...
                                  nomination form to be filled by interested
                                  eligible employees.
                                </li>
                                <br />
                                <li>
                                  3. At the close of nominations, votes shall be
                                  cast and the candidates that obtain a simple
                                  majority shall be declared elected.
                                </li>
                                <br />
                                <li>
                                  4. Where there is a tie, a run-off election
                                  shall be conducted to determine the winner.
                                </li>
                                <br />
                              </ul>
                            </h5>
